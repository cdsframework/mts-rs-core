 ...
 * @author sdn
 */
@Path(ConfigServiceConstantsCore.BASE_RS_ROOT + "/" + ConfigServiceConstantsCore.CORE_RS_ROOT)
public class ConfigServiceCore extends BaseConfigService {

    public ConfigServiceCore() {
        super(PluginConfigCore.class, ConfigServiceConstantsCore.CORE_RS_ROOT);
    }
